...
<xsl:stylesheet
    ...
    <xsl:param
        name="param_original_filename"
        select="'ceww_entryxx.xml'"/>
    ...
    <xsl:template
        ...
        <mods
            ...
            <!-- <name> element -->
            <xsl:for-each
                select="/CWRC/CWRCHEADER[1]/FILEDESC[1]/TITLESTMT[1]/DOCAUTHOR">
                <xsl:if
                    test="normalize-space(.) = 'Canada''s Early Women Writers'">
                    <name
                        type="corporate">
                ...
                <xsl:if
                    ...
                    <name
                        ...
                        <namePart>
                            <xsl:value-of
                                select="normalize-space(replace(., 'Revised by ', ''))"/>
                        </namePart>
                        <role>
                            <roleTerm
                                type="text"
            ...
            <genre
                authority="cwrc"
                type="format">Born digital</genre>
            <genre
                authority="cwrc"
                type="primaryGenre">Life writing</genre>
            <genre
                authority="cwrc"
                type="subGenre">Biography</genre>
            <genre
                authority="cwrc"
                type="subGenre">Bibliography</genre>
            ...
            <language>
                ...
                <scriptTerm
                    type="text">Latin</scriptTerm>
                <scriptTerm
                    type="code"
                    authority="iso15924">Latn</scriptTerm>
            </language>
            
            <!-- abstract element -->
            <xsl:if
                test="normalize-space(/CWRC/ENTRY[1]/AUTHORSUMMARY[1]/P[1]) != ''">
                <abstract>
                    <xsl:value-of
                        select="normalize-space(/CWRC/ENTRY[1]/AUTHORSUMMARY[1]/P[1])"/>
                </abstract>
            </xsl:if>
            
            <!-- subject element -->
            <xsl:if
                test="normalize-space(/CWRC/ENTRY[1]/FRONT[1]/HEADING[1]/NAME[1]/@REF) != ''">
                <subject>
                    <name>
                        <xsl:attribute
                            name="valueURI">
                        ...
                        <xsl:if
                            test="normalize-space(/CWRC/ENTRY[1]/FRONT[1]/HEADING[1]/NAME[1]) != ''">
                            <xsl:element
                                name="namePart">
                                <xsl:value-of
            ...
            <accessCondition
                type="use and reproduction">This work is licensed under a <a
                    rel="license"
