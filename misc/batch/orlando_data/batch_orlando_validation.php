...
$schema_writing         = "http://cwrc.ca/schemas/orlando_writing.rng";
$schema_bio             = "http://cwrc.ca/schemas/orlando_biography.rng";
//$schema_writing         = "http://cwrc.ca/schemas/orlando.rng";
//$schema_bio             = "http://cwrc.ca/schemas/orlando.rng";
$schema_event           = "http://cwrc.ca/schemas/orlando_events.rng";
$schema_biblography     = "http://cwrc.ca/schema/bibliography";
$schema_documentation   = "http://cwrc.ca/schemas/legacy_orlando_documentation.rng";
$schema_type = "RNG_XML";
$username = "";
$password = "";
...
$xml_docType=
    '<!DOCTYPE AUTHORITYLIST[ <!ENTITY % character_entities SYSTEM "http://cwrc.ca/schemas/character_entities.dtd"> %character_entities; ]>
        '
    ;
