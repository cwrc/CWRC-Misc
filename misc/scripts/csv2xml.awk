...
#     ./csv2xml.awk input-file > output-file [on Unix machines]
#     awk -f csv2xml.awk input-file > output-file [on Windows machines]
...
BEGIN { FS="\t"; } # MRB: set the field separator (FS) character, e.g., "\t"
