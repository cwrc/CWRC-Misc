...
# piped as standard input to xargs.  Using the arguments from xargs, the mv command is used to
# move the Orlando entity files from the "data" directory to the "orlando" directory, a new
